...
---
ODK Collect v1.5.1 is now available on the [Google Play Store](https://play.google.com/store/apps/details?id=org.odk.collect.android)! It’s also available for download [here](https://github.com/getodk/collect/releases).
...
Read [full release notes](https://github.com/getodk/collect/releases) and upgrade today! If you run into any problems, please file them on the [issue tracker](https://github.com/getodk/collect/issues).
